...
class Base_task(gym.Env):
    ...
    def apply_r3dp(self, model, args):
        cnt = 0
        self.test_num += 1
        ...
        eval_video_log = args['eval_video_log']
        video_size = str(args['head_camera_w']) + 'x' + str(args['head_camera_h'])
        save_dir = f'r3dp_tau{args["tau"]}/' + f"{str(args['task_name'])}/" + str(args['task_name']) + '_' + str(args['head_camera_type']) + '_' + str(args['expert_data_num']) + '_' + 'seed' + str(args['expert_seed']) + '_' + 'ckpt' + str(args['checkpoint_num'])
